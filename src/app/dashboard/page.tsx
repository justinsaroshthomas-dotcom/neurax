...
import { NeuraxEncyclopedia } from "@/components/dashboard/NeuraxEncyclopedia";
...
export default function DashboardPage() {
    ...
    const [tab, setTab] = useState<"diagnostics" | "encyclopedia">("diagnostics");
    ...
    return (
        <div className="max-w-5xl mx-auto space-y-10 animate-in fade-in duration-1000 relative">
            ...
            {/* ── STEP 1: Input (Diagnostics or Encyclopedia) ── */}
            {!hasResults && (
                            ...
                            <>
                                ...
                                <div className="flex flex-col items-center gap-4 pt-4">
                                    ...
                                    >
                                        ...
                                        Process Analysis {selectedSymptoms.length > 0 ? `[${selectedSymptoms.length}]` : ""}
                                    </button>
