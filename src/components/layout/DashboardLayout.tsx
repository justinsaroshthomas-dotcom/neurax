            ...
            <div className="flex min-h-screen flex-1 flex-col overflow-hidden">
                ...
                <main className="flex-1 overflow-x-hidden overflow-y-auto px-4 pb-8 pt-4 md:px-6 lg:px-8">
                    <div className="mx-auto flex min-h-full w-full max-w-[1520px] flex-col">
                        <div className="flex-1 rounded-[2.5rem] border border-white/40 bg-[linear-gradient(180deg,rgba(255,255,255,0.72),rgba(255,255,255,0.46))] p-4 shadow-[0_30px_90px_-52px_rgba(15,23,42,0.55)] backdrop-blur-2xl dark:border-white/10 dark:bg-white/5 md:p-6 lg:p-7">
                            {children}
                        </div>
